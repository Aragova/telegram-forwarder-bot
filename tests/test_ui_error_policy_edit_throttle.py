...
def test_edit_message_throttled():
    ...
    first = asyncio.run(policy.edit_text(chat_id=123, message_id=456, text="Первый текст"))
    second = asyncio.run(policy.edit_text(chat_id=123, message_id=456, text="Второй текст"))
