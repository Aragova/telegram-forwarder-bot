...
def test_sender_job_executor_accepts_extended_payload_contract() -> None:
    params = inspect.signature(SenderService.execute_repost_single_from_job).parameters
    assert "mode" in params
    assert "schedule_mode" in params
    assert "media_group_id" in params
